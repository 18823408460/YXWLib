...
import com.uurobot.yxwlib.okhttp.yunwenTest.bean.GetRobatResult;
import com.uurobot.yxwlib.okhttp.yunwenTest.bean.MyQuestion;
import com.uurobot.yxwlib.okhttp.yunwenTest.bean.RobotAnswer;
...
public class HtmlParser {
    ...
    public static GetRobatResult getMoreQuestionContent(String initalQuestion, GetRobatResult getRobatResult) {
        ...
        robotAnswer.setMsgType(Constant.Type.TXT);
