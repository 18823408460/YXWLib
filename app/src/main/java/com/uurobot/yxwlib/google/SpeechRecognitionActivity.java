...
//                        }
                ...
                public void handleMessage(Message msg){
                        switch (msg.what){
                                ...
                                case MSG_RECORD_RECORDING:
                                        ...
                                        int volume = msg.arg1;
                                        Log.d(TAG,"Record recording.Volume = "+volume );
                                        if (lastTalkTime == 0){
                                                if (volume >= 50){
                                ...
                                case MSG_RECORD_STOPPED:
                                        Log.d(TAG,"Recorder stopped, try to get remote data");
                                ...
                                case MSG_DECODE_DATA:
                                        ...
                                        Log.d(TAG,"Try to parse data :" + data);
                                ...
                                case MSG_ERROR:
                                        ...
                                        intent.putExtra(GoogleStartActivity.SPEECH_RESULT_STATUS,msg.arg1);
                                        if (msg.obj != null){
                                                Log.d(TAG,"Error:"+msg.arg1+";value"+msg.obj);
                                                intent.putExtra(GoogleStartActivity.SPEECH_RESULT_VALUE,msg.obj.toString());
                                        }
        ...
        private void prepareRecorder(){
                ...
                if (minBufferSize == AudioRecord.ERROR_BAD_VALUE){
                        Log.e(TAG, "Params are not support by hardware.n"
        ...
        private void startWebRecognizer(final byte[] wavData){
                ...
                if (connection == null){
                        Log.e(TAG,"startWebRecognizer null");
                        ...
                        new Thread(){
                                ...
                                public void run(){
                                        try {
                                                ...
                                                Log.e(TAG,"startWebRecognizer sb="+sb.toString());
                                                Message msg = mHandler.obtainMessage(MSG_DECODE_DATA,sb.toString());
                                                mHandler.sendMessage(msg);
                                        }catch (IOException ex){
                                                Log.e(TAG,"startWebRecognizer IOException="+ex);
                                                Message msg = mHandler.obtainMessage(MSG_ERROR,ERR_NETWORK,0);
                                                mHandler.sendMessage(msg);
                                        }
                                }
        ...
        private void startParseJson(String jsonString){
                try{
                        ...
                        Log.e(TAG,"Decode JSON error",ex);
